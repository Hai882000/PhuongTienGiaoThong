...
public class QuanLyThongTinXe extends javax.swing.JPanel {
    ...
    private void btnThemActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnThemActionPerformed
        ...
        try {
            ...
            for(XeMay xemay : xm){
                if(xemay.getMaXM().equalsIgnoreCase(txtMaLoaiXe.getText())){
                    KTMLX = true;
                }
            }
            ...
            for(OTo oto : ot){
                if(oto.getMaOT().equalsIgnoreCase(txtMaLoaiXe.getText())){
                    KTMLX = true;
                }
            }
            ...
            for(XeTai xetai : xt){
                if(xetai.getMaXT().equalsIgnoreCase(txtMaLoaiXe.getText())){
                    KTMLX = true;
                }
            }
            ...
            if(KTMLX == true){
                ...
                if(CheckTTX == true){
                    MessageDialogHelper.showConfirmDialog(parentForm, "Thông tin xe đã tồn tại", "Cảnh báo");
                }else{
                    if (dao.insert(ttx)) {
    ...
    private void btnTimActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnTimActionPerformed
        try
        {
            ...
            if(!"".equals(txtBienSoTK.getText())){
                ...
                if(ttx.getTinhTrang().startsWith("XM")){
                    txtMaLoaiXe.setText(ttx.getMaXM());
                }else if(ttx.getTinhTrang().startsWith("OT")){
                    txtMaLoaiXe.setText(ttx.getMaOT());
                }else{
                    txtMaLoaiXe.setText(ttx.getMaXT());
                }
