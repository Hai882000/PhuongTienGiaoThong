...
public class QuanLyKhachHang extends javax.swing.JPanel {
    ...
    private void btnThemActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnThemActionPerformed
        ...
        try
        {
            ...
            if(CheckMKH == true){
                MessageDialogHelper.showConfirmDialog(parentForm, "Khách hàng đã tồn tại!","Cảnh báo!");
            }else{
                if(dao.insert(kh))
                {
    ...
    private void btnXoaActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnXoaActionPerformed
        ...
        try
        {
            ...
            {
                MessageDialogHelper.showConfirmDialog(parentForm, "Khách hàng không được xóa !","Cảnh báo!");
            }
    ...
    private void btnTimKiemActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnTimKiemActionPerformed
        ...
        {
            KhachHangDao dao = new KhachHangDao();
            KhachHang kh = dao.findDung(txtMaKHTimKiem.getText());
            if(kh !=null)
            {
