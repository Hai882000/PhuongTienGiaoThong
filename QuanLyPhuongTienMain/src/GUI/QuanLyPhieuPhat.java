...
public class QuanLyPhieuPhat extends javax.swing.JPanel {
                            ...
                            .addGroup(layout.createSequentialGroup()
                                ...
                                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                    ...
                                    .addGroup(layout.createSequentialGroup()
                                        ...
                                        .addGap(32, 32, 32)
                                        .addComponent(txtNoiDung, javax.swing.GroupLayout.PREFERRED_SIZE, 426, javax.swing.GroupLayout.PREFERRED_SIZE))
                                    .addGroup(layout.createSequentialGroup()
                                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
    ...
    private void btnLapPhieuActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnLapPhieuActionPerformed
        ...
        try {
            ...
            for(PhieuThue pt : lpt){
                if(pt.getMaPT().equalsIgnoreCase(txtMaHD.getText())){
                    KTPT = true;
                    if(pt.getMaNV().equalsIgnoreCase(txtMaNV.getText())){
                        KTNV = true;
                        if(pt.getMaKH().equalsIgnoreCase(txtMaKH.getText())){
                            KTKH = true;
                        }
                    }
                }
            ...
            for(PhieuPhat pp : lpp){
                if(pp.getMaPT().equalsIgnoreCase(txtMaHD.getText())){
                    KTPP = true;
                }
            }
            if(KTPT == true){
                if(KTNV == true ){
                    if(KTKH == true){
                        if(KTPP == false){
                            ...
                            pp.setMaPP(txtMaPhieuPhat.getText());
                            ...
                            MessageDialogHelper.showConfirmDialog(parentForm, "Phiếu thuê này đã tồn tại", "Cảnh báo");
                            return;
                        }
                    }else{
                        MessageDialogHelper.showConfirmDialog(parentForm, "Vui lòng nhập đúng mã khách hàng trong phiếu thuê ", "Cảnh báo");
                        return;
                    }   
                }else{
                    MessageDialogHelper.showConfirmDialog(parentForm, "Vui lòng nhập đúng mã nhân viên trong phiếu thuê", "Cảnh báo");
                    return;
                }
            }else{
                MessageDialogHelper.showConfirmDialog(parentForm, "Mã phiếu thuê không tồn tại", "Cảnh báo");
                return;
            }
    ...
    private void btnSuaActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnSuaActionPerformed
        ...
        try {
            ...
            PhieuPhatDao dao = new PhieuPhatDao();
            if (dao.update(pt)) {
                MessageDialogHelper.showMessageDialog(parentForm, "Người dùng đã được lưu", "Thông báo");
                loadDataToTable();
            } else {
                MessageDialogHelper.showConfirmDialog(parentForm, "Người dùng không được lưu do lỗi", "Cảnh báo");
            }
    ...
    private void btnTimActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnTimActionPerformed
        ...
        {
            PhieuPhatDao dao = new PhieuPhatDao();
            PhieuPhat pt = dao.findById(txtMaPhieuTK.getText());
            if(pt !=null)
            {
                txtMaPhieuPhat.setText(pt.getMaPP());
                txtMaHD.setText(pt.getMaPT());
